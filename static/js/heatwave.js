...
const ctx = document.getElementById("chart-heatwave").getContext("2d")

const lineButton = document.getElementById("line-graph-btn-heatwave")
const barButton = document.getElementById("bar-graph-btn-heatwave")

const areaButtonsDiv = document.getElementById("areas-div-heatwave")
const toggleButtons = []
...
const init = async () => {
    const api_data = await fetch("/avg_temp")
